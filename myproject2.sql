...
--
-- Host: localhost
-- Generation Time: Dec 22, 2017 at 09:26 AM
...
(177, '', '', '', 1, 'Nhóm thuộc tính', 0),
(178, 'admin', 'groupproperty', 'index', 1, 'Danh sách', 177),
(179, 'admin', 'groupproperty', 'add', 1, 'Thêm', 177),
(180, 'admin', 'groupproperty', 'delete', 1, 'Xóa', 177),
(181, 'admin', 'groupproperty', 'edit', 1, 'Cập nhật', 177),
(182, NULL, NULL, NULL, 1, 'Thuộc tính', 0),
(183, 'admin', 'property', 'index', 1, 'Danh sách', 182),
(184, 'admin', 'property', 'add', 1, 'Thêm', 182),
(185, 'admin', 'property', 'delete', 1, 'Xóa', 182),
(186, 'admin', 'property', 'edit', 1, 'Cập nhật', 182),
(187, '', '', '', 1, 'Chi tiết thuộc tính', 0),
(188, 'admin', 'propertydetail', 'index', 1, 'Danh sách', 187);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=9484 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3975 ;
...
(31, 'Sản phẩm', 3, 1, '', 'fa fa-cubes', 6),
(32, 'Danh sách', 31, 1, 'admin/product/index', '', 1),
(34, 'Danh mục', 31, 1, 'admin/product-category/index', '', 3),
(35, 'Thuộc tính', 31, 1, '', '', 1),
(36, 'Nhóm thuộc tính', 35, 1, 'admin/group-property/index', '', 1),
(37, 'Thuộc tính', 35, 1, 'admin/property/index', '', 2);
...
INSERT INTO `post` (`post_id`, `post_title`, `post_quote`, `post_body`, `post_picture`, `post_date_created`, `post_date_updated`, `post_users_created`, `post_type`, `post_status`, `post_users_updated`, `post_view`, `post_tag`) VALUES
(1, '546456', '', '', NULL, '2017-12-19 10:21:52', '2017-12-19 10:21:52', 3, 1, 1, 3, 0, ''),
(2, 'asd', '<p>sd</p>', '<p>asd</p>', 'post_1513653726.5972_img.jpg', '2017-12-19 10:22:06', '2017-12-19 10:22:06', 3, 1, 1, 3, 0, '');
...
(1, 'Tin tức', 0, 1, '2017-11-01 10:15:59', '2017-11-10 10:42:41', 3, 3);
...
INSERT INTO `product` (`product_id`, `product_name`, `product_picture`, `product_price`, `product_status`, `product_date_created`, `product_date_updated`, `product_users_created`, `product_users_updated`, `product_body`, `product_view`) VALUES
(1, '123', NULL, 123, 1, '2017-12-18 17:09:24', '2017-12-18 17:09:24', 3, 3, '<p>123</p>', NULL),
(2, '123', NULL, 123, 1, '2017-12-18 17:10:06', '2017-12-18 17:10:06', 3, 3, '<p>123</p>', NULL),
(3, '123', NULL, 123, 1, '2017-12-18 17:10:34', '2017-12-18 17:10:34', 3, 3, '<p>123</p>', NULL),
(4, '123', NULL, 123, 1, '2017-12-18 17:10:54', '2017-12-18 17:10:54', 3, 3, '<p>123</p>', NULL),
(5, '123df', NULL, 123, 1, '2017-12-18 17:11:04', '2017-12-19 10:15:54', 3, 3, '<p>123fsdfdsf</p>', NULL),
(6, 'asd', NULL, 200000000, 1, '2017-12-19 10:18:11', '2017-12-19 11:26:35', 3, 3, '<p>asd</p>', NULL);
...
CREATE TABLE IF NOT EXISTS `property` (
  ...
  `property_key` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `property` (`property_id`, `property_name`, `group_property_id`, `property_type`, `property_status`, `property_key`) VALUES
(1, 'sdf', NULL, 'text', 1, NULL);
...
INSERT INTO `property_detail` (`property_detail_id`, `property_detail_name`, `property_detail_value`, `property_id`) VALUES
(1, 'asdsdf', 'asddfdf', 1);
...
(3, 'Anh Tuấn', '', 'anhtuan150787@gmail.com', 'e49ed34b584d6a4ac562647850517b13', '2017-08-10 11:56:56', 1, 'users_1503035528_1910224703_hop-190x120x60mm.png', '65601daf9197d19f660233df5f7961c9', '2017-12-20 10:33:23', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36', 1, ''),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_product` AS select `product`.`product_id` AS `product_id`,`product`.`product_name` AS `product_name`,`product`.`product_body` AS `product_body`,`product`.`product_picture` AS `product_picture`,`product`.`product_date_created` AS `product_date_created`,`product`.`product_date_updated` AS `product_date_updated`,`product`.`product_users_created` AS `product_users_created`,`product`.`product_status` AS `product_status`,`product`.`product_users_updated` AS `product_users_updated`,`product`.`product_view` AS `product_view`,`users`.`users_fullname` AS `users_fullname` from (`product` left join `users` on((`users`.`users_id` = `product`.`product_users_updated`)));
