...
class GroupNavigationController extends MasterController
{
    public function __construct()
    {
        $this->module       = 'group-navigation';
        $this->moduleName   = 'Menu';
        $this->modelName    = 'GroupNavigationModel';
        $this->formName     = '\Admin\Form\GroupNavigationForm';
    ...
    public function addAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($this->formIsValid()) {
                ...
                $this->flashMessenger()->addMessage('Thêm mới thành công. Vui lòng tạo liên kết cho Menu này.', 'msgInfo');
                $this->redirect()->toRoute('admin/default', ['controller' => 'navigation', 'action' => 'index'], ['query' => ['group_navigation_id' => $idLastInsert]]);
            }
        }
