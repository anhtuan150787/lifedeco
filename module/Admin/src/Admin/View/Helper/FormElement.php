...
class FormElement extends AbstractHelper
{
    ...
    public function picture_multi($formElement, $module, $record, $url, $primary)
    {
        return $this->view->partial('admin/partial/form_element/picture_multi', ['formElement' => $formElement, 'module' => $module, 'record' => $record, 'url' => $url, 'primary' => $primary]);
    }
